...
let exp28 = (false + 1) * "hello" || 3 + (a-- && 5) * "result" || "world";let exp29 = "start" + 2 * (true || 1) && (false || "value") * 5 + "result";
console.log(exp28);
...
let exp49 = (2 * 3) + "result" && 4 * (a-- + 1) || "start" + 2 + "end";	let exp50 = 32 && true - ++a && " " || "true";
 console.log(exp49);
